...
const DonorRegisterPage = () => {
    ...
    useEffect(() => {
        initGoogleAuth().then(() => {
            renderGoogleButton('googleSignInButtonDonor', handleGoogleCallback);
        });
    }, []);
    ...
    return (
        <Box
            sx={{
                minHeight: '100vh',
                background: `linear-gradient(135deg, ${alpha('#dc004e', 0.05)} 0%, ${alpha('#f73378', 0.05)} 100%)`,
                display: 'flex',
                alignItems: 'center',
                py: 4,
            }}
            ...
            <Container maxWidth="sm">
                ...
                >
                    ...
                    <Box sx={{ mt: 2 }}>
                        ...
                        <Box id="googleSignInButtonDonor" sx={{ display: 'flex', justifyContent: 'center' }}></Box>
                    </Box>
